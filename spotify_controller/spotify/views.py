...
def spotify_callback(request, format=None):
    ...
    #Create a database of tokens where you can search the room associated to the token
...
#View is going to be responsible for retrieving information of the current song
class CurrentSong(APIView):
    def get(self, request, format=None):
        ...
        #Return out custom object called song back to the frontend
